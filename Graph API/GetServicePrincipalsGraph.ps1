...
try {
        ...
        #This gets Enterprise applications and application registrations
        #$Result = Invoke-RestMethod -Uri 'https://graph.microsoft.com/v1.0/servicePrincipals' -Headers $Headers

        #This gets application registrations only
        $Result = Invoke-RestMethod -Uri 'https://graph.microsoft.com/v1.0/applications' -Headers $Headers
